"""
Django settings for kommander project.
...
WSGI_APPLICATION = 'kommander.wsgi.application'
...
STATIC_ROOT = '/usr/share/nginx/html/static/kommander/'
STATIC_URL = '/static/kommander/'
...
with open(BASE_DIR / 'kommander/email_config.json') as f:
